...
\begin{figure}[h!]
    ...
    \includegraphics[angle=90, height = 20cm, width = 17cm]{../MAXI_ARCHI2.png}
    \label{fig:PropProf}
\end{figure}
\end{center}
...
Voici la page d'accueil du produit, celle ci décrit les principaux éléments à connaître pour le gestionnaire telles que les échéances, le nombre de parts vendues, le ratio entre le nombre de parts vendues et le nombre de parts totales. \\
Nous avons modéliser dans un premier temps la navigation par des boutons mais en réalité, ce sera plutôt un système d'onglet.
...
Le troisième onglet permet de paramétriser notre modèle pour obtenir une couverture associée. Lorsque l'on choisit un modèle, des cases apparaissent associés aux différents paramètres du modèle, ces paramètres ont des valeurs par défaut mais il est conseillés au gestionnaire d'entrer ses propres paramètres pour affiner la précision du modèle.

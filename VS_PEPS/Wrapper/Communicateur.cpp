...
double strike, double maturity, array<double> ^sigma_sharp, double r, array<double> ^rho_sharp, array<double> ^coeff_sharp, int timeStep, int samples){
	...
	*/
	void CommunicateurClass::getPriceOption(int M, double T, double S0, double K, double sigma, double r, int size, int timeStep)
	{
		double ic = 0;
		double px = 0;
	...
	void CommunicateurClass::getCouv(int M, double T, double S0, double K, double sigma, double r, int size, int timeStep)
	{
		double pL = 0;
